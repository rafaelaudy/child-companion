...
export const TOPICS_BY_WEEKS = {
  [TopicKeys.Developing]: {
    ...
    <li><strong>Recognizing Faces and Voices</strong> – She may show excitement when she sees familiar faces and respond more to your voice and expressions.</li>
    <li><strong>Early Vocalizations</strong> – You might hear more cooing, gurgling, and attempts at different sounds as she experiments with her voice.</li>
    <li><strong>Better Hand-to-Mouth Coordination</strong> – She may start bringing her hands, fingers, or toys to her mouth more often to explore textures.</li>
  ...
  [TopicKeys.Enjoying]: {
    ...
    <li><strong>Enjoying Tummy Time:</strong> With stronger neck and arm muscles, tummy time is more fun and engaging.</li>
    <li><strong>Fascination with Hands:</strong> Your baby may spend time staring at their hands, moving them, and even bringing them to their mouth.</li>
    <li><strong>Tracking Moving Objects:</strong> Their vision is improving, making it easier to follow moving toys or people.</li>
    <li><strong>Reacting to Familiar Faces:</strong> Your baby is recognizing and reacting joyfully to parents and caregivers.</li>
    <li><strong>More Interest in Toys:</strong> Soft, colorful toys and textured objects capture their attention for longer periods.</li>
    <li><strong>Responding to Music:</strong> Gentle tunes and rhythmic sounds can calm, entertain, or even excite your baby.</li>
...
`,
  ...
  <li><strong>Mirrors:</strong> Place a baby-safe mirror in front of them. Babies at this age enjoy looking at their reflection, even though they don’t fully recognize themselves yet.</li>
  <li><strong>Play with soft toys:</strong> Use soft, colorful toys that make sounds, such as rattles or crinkly toys. This helps stimulate sensory development.</li>
  <li><strong>Read books:</strong> While they may not understand the story, your baby will enjoy hearing the rhythm of your voice and looking at bright, contrasting pictures.</li>
  <li><strong>Exploration of textures:</strong> Gently let them feel different textures, like soft blankets or safe sensory toys, to stimulate tactile development.</li>
...
`,
  ...
  <li><strong>Tummy Time</strong>: Increase tummy time to strengthen neck, back, and arm muscles. Use toys to motivate her to lift her head and push up on her arms.</li>
  <li><strong>Talking and Mimicking Sounds</strong>: Begin talking to your baby often, and encourage her to make sounds in response. Imitating simple coos or babbling helps with early communication.</li>
  <li><strong>Hand-Eye Coordination</strong>: Use brightly colored objects to encourage reaching and batting with her hands, which aids in hand-eye coordination development.</li>
